...
class DepDetailsGrid extends StatefulWidget {
  const DepDetailsGrid({
    Key? key,
    required this.text,
  ...
  @override
  State<DepDetailsGrid> createState() => _DepDetailsGridState();
}

class _DepDetailsGridState extends State<DepDetailsGrid> {
  @override
