...
class SingleFavoriteProductCard extends StatelessWidget {
  final String imagePath;

  const SingleFavoriteProductCard({this.imagePath: ""});
    ...
    return Row(
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            margin: EdgeInsets.only(left: listViewHorizontalSpacing * width(context)),
            child: Neumorphic(
              child: Container(
                child: Column(
                  children: [
                    ...
                    Neumorphic(
                      child: Container(
                        ...
                        height: isLandscape(context) ? 2 * height(context) * .09 : height(context) * .09,
                      ),
                    ),
                    const CustomSizedBox(percentageOfHeight: .01),
                    Container(
