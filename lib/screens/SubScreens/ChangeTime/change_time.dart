...
class ChangeTimeScreen extends StatefulWidget {
  const ChangeTimeScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${orderController.ordersDetailsModel.date}'
                            ' ${orderController.ordersDetailsModel.dayOfWeek}'
                            ' ${orderController.ordersDetailsModel.time}',
                            style: titleNormal(color: mainColor),
                          ),
      ...
      bottomNavigationBar: GetBuilder<OrderController>(
        builder: (orderController) => orderController.isLoading
            ? SizedBox(
                width: double.infinity,
                height: 50.h,
                child: MainLoader(),
            ...
            : GestureDetector(
                onTap: () {
                  ...
                  orderController.confirmChangeOrderTime();
                },
                child: Container(
                  width: double.infinity,
                  height: 50.h,
