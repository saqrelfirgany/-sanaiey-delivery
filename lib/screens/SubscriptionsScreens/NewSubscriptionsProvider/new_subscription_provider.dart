...
class NewSubscriptionsProviderScreen extends StatefulWidget {
  const NewSubscriptionsProviderScreen({Key? key}) : super(key: key);

  @override
  State<NewSubscriptionsProviderScreen> createState() => _NewSubscriptionsProviderScreenState();
}

class _NewSubscriptionsProviderScreenState extends State<NewSubscriptionsProviderScreen> {
