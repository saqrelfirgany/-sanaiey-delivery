...
class NewSubscriptionsDateScreen extends StatefulWidget {
  const NewSubscriptionsDateScreen({Key? key}) : super(key: key);

  @override
  State<NewSubscriptionsDateScreen> createState() => _NewSubscriptionsDateScreenState();
}

class _NewSubscriptionsDateScreenState extends State<NewSubscriptionsDateScreen> {
              ...
              builder: (orderController) => GestureDetector(
                onTap: () async {
                  ...
                  if (orderController.isAllow) {
                    fadNavigate(context, NewSubscriptionsProviderScreen());
                  } else {
                    setState(() {
                      _isLoading = true;
                    });
